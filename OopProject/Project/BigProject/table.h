...
public:
	...
	int cnum_f(){ return cnum; }                                       //表的列数
	int rnum_f(){ return rnum; }                                     //表的行数
	int primary_f(){ return primary; }                                    //主键位置
	string pri_type_f(){ return pri_type; }                                //主键类型
	vector <string> record_f(){ return record; }                         //所有数据
	vector <string> col_name_f(){ return col_name; }                       //所有列名
	map<string, col_info> columns_f(){ return columns; }                   //列信息，列名和列信息对应
};
